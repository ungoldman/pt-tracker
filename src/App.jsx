...
const App = () => {
  ...
  const [collapsedCategories, setCollapsedCategories] = useState(() => {
    const saved = localStorage.getItem('ptTrackerCollapsedCategories');
    return saved ? JSON.parse(saved) : {};
  });
  ...
  useEffect(() => {
    localStorage.setItem('ptTrackerCollapsedCategories', JSON.stringify(collapsedCategories));
  }, [collapsedCategories]);
                              ...
                              {!isExpanded ? (
                                ...
                                >
                                  ...
                                  {hasNote && (
                                    <BellRing
                                      size={12}
                                      className="text-orange-400 fill-amber-300"
                                    />
                                  )}
                                </button>
                              ) : (
                                ...
                                >
                                  ...
                                  <textarea
                                    ...
                                    rows={
                                      noteText
                                        ? Math.max(2, Math.ceil(noteText.split('\n').length))
                                        : 2
                                    }
